...
class GeneratedPasswordSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'generated_by', 'password',
                  'strength', 'date_generated']
        # Prevent users from manually setting these fields
        read_only_fields = ['generated_by', 'date_generated']
